...
Dieselben drei Läufe stehen als GitHub-Action in
[`.github/workflows/ci.yml`](.github/workflows/ci.yml) und laufen bei jedem Push und jedem Pull
Request. Lokal grün und im Zweig rot ist sonst ein Zustand, den niemand bemerkt.
